...
public class ArtistDetailsSongsRVAdapter extends RecyclerView.Adapter<ArtistDetailsSongsRVAdapter.SongItemViewHolder> {
    ...
    public ArtistDetailsSongsRVAdapter(List<Song> data) {
        this.data = data;
