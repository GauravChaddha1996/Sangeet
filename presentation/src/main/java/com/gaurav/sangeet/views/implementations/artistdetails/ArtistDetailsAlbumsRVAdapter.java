package com.gaurav.sangeet.views.implementations.artistdetails;
...
public class ArtistDetailsAlbumsRVAdapter extends RecyclerView.Adapter<ArtistDetailsAlbumsRVAdapter.AlbumsViewHolder> {

    private List<Album> data;
    private Album album;
    private Transformation roundedCornersTransformation;

    public ArtistDetailsAlbumsRVAdapter(List<Album> data) {
        this.data = data;
